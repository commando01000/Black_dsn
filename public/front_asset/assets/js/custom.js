...
const dsnParam = {
    map: {
        marker_icon: "front_asset/assets/img/map-marker.png",
...
(function ($) {
    ...
    function contactValidator() {
        ...
        contact_form.validator(); // Initialize the validator

        contact_form.on("submit", function (e) {
            e.preventDefault(); // Prevent the default form submission

            if (!e.isDefaultPrevented()) {
                var url = contact_form.data("url"); // Get the URL from the data attribute
                console.log(url);
                // POST values in the background to the Laravel route
                $.ajax({
                    type: "POST",
                    ...
                    success: function (data) {
                        ...
                        if (messageAlert && messageText) {
                            // Inject the alert into the .messages div in the form
