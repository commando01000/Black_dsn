                            ...
                            <div class="tab-pane fade show active" id="apps-setting" role="tabpanel"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                {{ Form::label('contact_address3', __('Address3'), ['class' => 'col-form-label']) }}
                                                <div class="custom-input-group">
                                                    {!! Form::text('contact_addrees3', Utility::getsettings('contact_addrees3'), [
                                                        'class' => 'form-control',
                                                        'placeholder' => __('Enter address3'),
                                                    ]) !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                {{ Form::label('contact_address4', __('Address4'), ['class' => 'col-form-label']) }}
                                                <div class="custom-input-group">
                                                    {!! Form::text('contact_addrees4', Utility::getsettings('contact_addrees4'), [
                                                        'class' => 'form-control',
                                                        'placeholder' => __('Enter address4'),
                                                    ]) !!}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                {{ Form::label('spapchat', __('Spapchat'), ['class' => 'col-form-label']) }}
                                                <div class="custom-input-group">
                                                    {!! Form::text('snapchat', Utility::getsettings('snapchat'), [
                                                        'class' => 'form-control',
                                                        'placeholder' => __('Enter snapchat page'),
                                                    ]) !!}
                                                </div>
                                            </div>
                                        </div>
