...
@section('breadcrumb')
    <div class="col-md-12">
        ...
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('design-category.index') }}">{{ __('Design Categories') }}</a></li>
        ...
        <div class="col-xl-6 col-lg-8 col-sm-12 col-12 m-auto">
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="text-end">
                        {!! Html::link(route('design-category.index'), __('Cancel'), ['class' => 'btn btn-secondary']) !!}
