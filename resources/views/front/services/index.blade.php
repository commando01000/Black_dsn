                    ...
                    <div class="intro-project w-100">
                        <div class="intro-title ">
                            ...
                            <div id="hero_title" class="mt-10">
                                <h1 class="title text-upper"> {{ Utility::getsettings('our-services.title') }}
                                </h1>
                            </div>
                            <p class="mt-20 max-w570">
                                {{ Utility::getsettings('our-services.description') }}
                            </p>
        ...
        <div class="box-under-img ">
            <div class="img-box-parallax before-z-index dsn-animate dsn-effect-down " data-dsn-triggerhook="bottom"
                ...
                <img class="has-bigger-scale cover-bg-img has-direction"
                    src='{{ asset('front_asset/assets/img/portfolio/project6/2.gif') }}' alt=''>
            </div>
        ...
        {{-- <div class="pt-section mb-section background-section">
            ...
            <div class="p-relative box-img">
                <div class="p-relative container d-grid grid-1-half mt-50 z-index-2">
                    <img src="{{ Storage::url(Utility::getsettings('services.what.we.do.background_1')) }}"
                        alt="{{ Utility::getsettings('services.what.we.do.title') }}">
                    <img class="d-sm-none"
                        src="{{ Storage::url(Utility::getsettings('services.what.we.do.background_2')) }}"
                        alt="{{ Utility::getsettings('services.what.we.do.title') }}">
                </div>
                    ...
                    <div class="team-item p-relative grid-item box-hover-image">
                        <div class="team-item-inner background-main">
                            <div class="avatar box-img" data-overlay="4">
                                <img class="cover-bg-img" src="{{ Storage::url($testimonial->image) }}"
                                    alt="{{ $testimonial->title }}">
                            </div>
                            <div class="team-content border-before text-center">
                                <h4 class="text-name sm-title-block">{{ $testimonial->title }}</h4>
                                <span class="text-position">{{ $testimonial->position }}</span>
        ...
        <div class="dsn-brand over-hidden mt-80 mb-80">
            <div class="dsn-grid-layout dsn-grid section-image section-move-image align-items-center use-horizontal-scroll-image"
                ...
                @foreach ($brands as $brand)
                    <div class="grid-item" style="width: 400px; height: 150px;">
