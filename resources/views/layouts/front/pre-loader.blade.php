    ...
    <div class="dsnload p-absolute">
        <span class="dsnload__row">
            <span class="dsnload__img">
                <img src= "{{ asset('front_asset/assets/img/DMF Logos/logo-white.png') }}" class="logo-dark"
                    alt="Digital Media Factory" decoding="async" loading="lazy">
                <img src= "{{ asset('front_asset/assets/img/DMF Logos/logo-dark.png') }}" class="logo-light"
                    alt="Digital Media Factory" decoding="async" loading="lazy">
            </span>
        </span>
