    ...
    <div class="dsnload p-absolute">
        <span class="dsnload__row">
            <span class="dsnload__img">
                <img src= "{{ asset('front_asset/assets/img/logo-light.png') }}" class="logo-dark" alt="Blackdsn"
                    decoding="async" loading="lazy">
                <img src="{{ asset('front_asset/assets/img/logo.png') }}" class="logo-light" alt="Blackdsn"
                    decoding="async" loading="lazy">
            </span>
        </span>
