...
<?php if($paginator->hasPages()): ?>
    <div class="dsn-pagination p-relative d-flex align-items-center">
        ...
        <?php if($paginator->onFirstPage()): ?>
            <span class="page-numbers disabled" aria-disabled="true" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>">
        ...
        <?php else: ?>
            <a class="page-numbers" href="<?php echo e($paginator->previousPageUrl()); ?>" rel="prev"
