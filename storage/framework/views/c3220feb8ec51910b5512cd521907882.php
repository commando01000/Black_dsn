...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('assets/front_assets/assets/img/logo-32x32.png')); ?>" sizes="32x32">
    <link rel="icon" href="<?php echo e(asset('assets/front_assets/assets/img/logo-192x192.png')); ?>" sizes="32x32">


    <title>Contact Us | Blackdsn</title>

    <link href="<?php echo e(asset('assets/front_assets/assets/css/plugins.css')); ?>" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('assets/front_assets/assets/css/style.css')); ?>">
        ...
        <div class="dsnload p-absolute">
            <span class="dsnload__row">
                <span class="dsnload__img">
                    <img src="<?php echo e(asset('assets/front_assets/assets/img/logo-light.png')); ?>" class="logo-dark"
                        alt="Blackdsn" decoding="async" loading="lazy">
                    <img src="<?php echo e(asset('assets/front_assets/assets/img/logo.png')); ?>" class="logo-light" alt="Blackdsn"
        ...
        <header id="site_menu_header" class="site-header  dsn-container d-none dsn-hamburger">
            <div class="main-logo">
                <a aria-current='page' class='custom-logo-link main-brand effect-ajax' data-dsn-text='Blackdsn'
                    ...
                    <img src="<?php echo e(asset('assets/front_assets/assets/img/logo-light.png')); ?>"
                        class="custom-logo logo-light" alt="Blackdsn">
                    <img src="<?php echo e(asset('assets/front_assets/assets/img/logo.png')); ?>" class="custom-logo logo-dark"
                        alt="Blackdsn">
                </a>
            </div>
                                    ...
                                    <div class="main-logo">
                                        <a href="https://dsngrid.com/blackdsn/" data-dsn-text="Blackdsn"
                                            ...
                                            <img class="custom-logo logo-light"
                                                src="<?php echo e(asset('assets/front_assets/assets/img/logo-light.png')); ?>"
                                                alt="Blackdsn">
                                            <img class="custom-logo logo-dark" src="<?php echo e(asset('assets/front_assets/assets/img/logo.png')); ?>"
                                                alt="Blackdsn">
                                        </a>
                                    </div>
                                </div>
...
<?php /**PATH G:\xampp\htdocs\Black_dsn\resources\views/front/contact/index.blade.php ENDPATH**/ ?>