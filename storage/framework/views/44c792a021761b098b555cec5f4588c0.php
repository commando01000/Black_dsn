                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <?php echo Form::text('name', $contact->name, [
                                            'class' => 'form-control',
                                            'disabled',
                                        ]); ?>
...
<?php echo $__env->make('layouts.back.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Black_dsn\resources\views/back/contact_us/view.blade.php ENDPATH**/ ?>