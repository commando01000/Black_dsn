                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <?php if($service->cover): ?>
                                        <div class="mt-3">
                                            <strong>Current Cover Image:</strong><br>
                                            <img src="<?php echo e(Storage::url($service->cover)); ?>" alt="<?php echo e($service->title); ?>"
...
<?php echo $__env->make('layouts.back.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\source\repos\Black_dsn\resources\views/back/service/view.blade.php ENDPATH**/ ?>