                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <?php $__currentLoopData = $design->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php echo Form::text('dribble', $detail->advantage, [
                                                'class' => 'form-control',
                                                'disabled',
                                            ]); ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <?php echo e(Form::label('cover', __('Cover Photo'), ['class' => 'form-label'])); ?> *
                                        <img src="<?php echo e(Storage::url($design->cover)); ?>" class="img-fluid"
...
<?php echo $__env->make('layouts.back.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/back/design/view.blade.php ENDPATH**/ ?>