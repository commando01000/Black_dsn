                    ...
                    <div class="dsn-logo main-logo">
                        <div class="main-logo">
                            <a href="https://dsngrid.com/blackdsn/" data-dsn-text="Blackdsn"
                                ...
                                <img class="custom-logo logo-light" src= "<?php echo e(asset('front_asset/assets/img/logo-light.png')); ?>" alt="Blackdsn">
                                <img class="custom-logo logo-dark" src= "<?php echo e(asset('front_asset/assets/img/logo.png')); ?>" alt="Blackdsn">
                            </a>
                        </div>
                    </div>
...
<?php /**PATH G:\xampp\htdocs\Black_dsn\resources\views/layouts/front/footer.blade.php ENDPATH**/ ?>