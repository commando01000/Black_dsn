    ...
    <div class="dsnload p-absolute">
        <span class="dsnload__row">
            <span class="dsnload__img">
                <img src= "<?php echo e(asset('front_asset/assets/img/DMF Logos/logo-white.png')); ?>" class="logo-dark"
                    alt="Digital Media Factory" decoding="async" loading="lazy">
                <img src= "<?php echo e(asset('front_asset/assets/img/DMF Logos/logo-dark.png')); ?>" class="logo-light"
                    alt="Digital Media Factory" decoding="async" loading="lazy">
            </span>
        </span>
...
<?php /**PATH C:\Users\dell\source\repos\Black_dsn\resources\views/layouts/front/pre-loader.blade.php ENDPATH**/ ?>