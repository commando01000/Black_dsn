    ...
    <header id="dsn_header" class="dsn-header-animation  show-box-shadow dsn-container section-padding v-dark-head">
        <div class="entry-header p-relative over-hidden">
            <div class="p-absolute dsn-hero-parallax-img over-hidden z-index-1 full-width" id="hero_image" data-dsn-ajax="img"
                data-overlay="4">
                <img class="cover-bg-img transform-3d" src="<?php echo e(Storage::url($design->cover)); ?>" alt="<?php echo e($design->title); ?>">
            </div>
                ...
                <div class="content p-relative ">
                    <div class="intro-project w-100">
                        <div class="intro-title ">
                            ...
                            <div id="hero_title">
                                <h1 class="title" data-dsn-ajax="title"><?php echo e($design->title); ?></h1>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="page_wrapper" class="wrapper">
            ...
            <div class="container text-center">
                ...
                <ul class="intro-project-list mt-30 d-grid grid-md-3">
                    ...
                    <li class="dsn-up grid-item number-item">
                        ...
                        <p class="description-list-project dsn-auto"><?php echo e($design->category->name); ?></p>
                    </li>

                    <li class="dsn-up grid-item number-item">
                        <h5 class="title-list-project sm-title-block">Industry</h5>
                        <p class="description-list-project dsn-auto"><?php echo e($design->title); ?></p>
                    </li>

                    <li class="dsn-up grid-item number-item">
                        <h5 class="title-list-project sm-title-block">Published</h5>
                        <p class="description-list-project dsn-auto"><?php echo e($design->created_at->format('F d, Y')); ?></p>
                    </li>
                </ul>
            </div>
        ...
        <div class="p-relative mb-section">
            ...
            <div class="dsn-container over-hidden">
                <div class="img-box-parallax dsn-animate dsn-effect-down h-v-80" data-dsn-triggerhook="bottom"
                    ...
                    <img class="cover-bg-img has-direction" src="<?php echo e(Storage::url($design->images[0]->image)); ?>"
                        alt="<?php echo e($design->title); ?>">
                    <div class="cap"><span><?php echo e($design->title); ?></span></div>
                </div>
            </div>
        </div>
        <!-- ========== End Parallax Image  ========== -->
            ...
            <div class="d-grid grid-sm-2 align-items-center" data-dsn-gap="80px 40px">
                <div class="p-relative img-box-parallax before-z-index has-popup" data-dsn="parallax">
                    <div class="effect-popup before-z-index h-v-70"
                        data-src="<?php echo e(Storage::url($design->images[1]->image)); ?>" data-caption="<?php echo e($design->title); ?>"
                        data-fancybox="_1" data-cursor="open" data-dsn-overlay="0">
                        <img class="cover-bg-img" src="<?php echo e(Storage::url($design->images[1]->image)); ?>" alt="">
                    </div>
                    <div class="cap">
                        <span><?php echo e($design->title); ?></span>
                    </div>
                </div>
                <div class="p-relative img-box-parallax before-z-index has-popup" data-dsn="parallax">
                    <div class="effect-popup before-z-index h-v-80"
                        data-src="<?php echo e(Storage::url($design->images[2]->image)); ?>" data-caption="<?php echo e($design->title); ?>"
                        data-fancybox="_1" data-cursor="open" data-dsn-overlay="0">
                        <img class="cover-bg-img" src="<?php echo e(Storage::url($design->images[2]->image)); ?>" alt="">
                    </div>
                    <div class="cap">
                        <span><?php echo e($design->title); ?></span>
                    </div>
        ...
        <div class="dsn-container over-hidden section-margin">
            <div class="img-box-parallax dsn-animate dsn-effect-down has-popup h-v-80" data-dsn-triggerhook="bottom"
                ...
                <div class="effect-popup before-z-index h-100" data-src="<?php echo e(Storage::url($design->images[3]->image)); ?>"
                    data-caption="<?php echo e($design->title); ?>" data-fancybox="_1" data-cursor="open" data-dsn-overlay="0">
                    <img class="cover-bg-img has-direction" src="<?php echo e(Storage::url($design->images[3]->image)); ?>"
        ...
        <div class="dsn-container p-relative mb-section">
            <div class="d-grid grid-sm-2 align-items-center" data-dsn-gap="80px 40px">
                <div class="p-relative img-box-parallax before-z-index has-popup" data-dsn="parallax">
                    <div class="effect-popup before-z-index h-v-80"
                        data-src="<?php echo e(Storage::url($design->images[4]->image)); ?>" data-caption="<?php echo e($design->title); ?>"
                        data-fancybox="_1" data-cursor="open" data-dsn-overlay="0">
                        <img class="cover-bg-img" src="<?php echo e(Storage::url($design->images[4]->image)); ?>" alt="">
                    </div>
                    <div class="cap">
                        <span><?php echo e($design->title); ?></span>
                    </div>
                ...
                <div class="p-relative img-box-parallax before-z-index has-popup" data-dsn="parallax">
                    <div class="effect-popup before-z-index h-v-70"
                        data-src="<?php echo e(Storage::url($design->images[5]->image)); ?>" data-caption="<?php echo e($design->title); ?>"
                        data-fancybox="_1" data-cursor="open" data-dsn-overlay="0">
                        <img class="cover-bg-img" src="<?php echo e(Storage::url($design->images[5]->image)); ?>" alt="">
                    </div>
                    <div class="cap">
                        <span><?php echo e($design->title); ?></span>
                    </div>
        ...
        <div class="next-project section-padding p-relative footer-animate svg-animate">
            ...
            <div data-dsn-ajax="img" class="p-absolute dsn-hero-parallax-img transform-3d bg-container over-hidden"
                data-overlay="4">
                <img class="cover-bg-img wp-post-image" src="<?php echo e(Storage::url($nextDesign->cover)); ?>" alt=""
                ...
                <div class="p-relative h-100 d-flex flex-column justify-content-center">
                    <div class="intro-project w-100">
                        <div class="intro-title text-center">
                            <div class="metas has-separate p-relative mb-10">
                                <?php echo e($nextDesign->category->name); ?>

                            </div>

                            <div class="hero-title fill-text">
                                <a class='d-inline-block effect-ajax' data-dsn-ajax='next'
                                    href='<?php echo e(route('design.show', $nextDesign->id)); ?>'>
                                    <h2 class="title"><?php echo e($nextDesign->title); ?></h2>
                                </a>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Black_dsn\resources\views/front/design/view.blade.php ENDPATH**/ ?>