        ...
        <nav class="main-navigation ">
            ...
            <ul id="dsn-primary-list" class="primary-nav h2">
                <li class="nav-item has-sub-menu">
                    <a title="Home" href="<?php echo e(route('homepage')); ?>">
                    ...
                    <ul class="nav-item">
                        ...
                        <li class="nav-item has-sub-menu">
                            ...
                            <ul class="nav-item">
                                ...
                                <li class="nav-item ">
                                    <a data-dsn-text='Our Portfolio' href='<?php echo e(route('our-portfolio')); ?>'
    ...
    <!-- ========== End Menu ========== -->
<?php /**PATH C:\Users\dell\source\repos\Black_dsn\resources\views/layouts/front/header.blade.php ENDPATH**/ ?>