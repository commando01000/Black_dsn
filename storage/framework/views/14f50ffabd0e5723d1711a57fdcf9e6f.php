                    ...
                    <div class="accordion__wrapper">
                        ...
                        <div class="accordion__item  ">
                            <div class="accordion__question user-no-selection  d-flex align-items-center  ">
                                ...
                                <h2 class="sm-title-block tab-title heading-color" role="tab" data-tab="3">
                                    Building
                                    ventures</h2>
                            </div>
                                            ...
                                            <div class="box-content d-flex ">
                                                <a class='effect-ajax box-image-link bg-shadow' data-dsn-ajax='work'
                                                    ...
                                                    <div class="box-image-bg before-z-index dsn-swiper-parallax-transform"
                                                        data-swiper-parallax-scale="1.2" data-overlay="4">
                                        ...
                                        <article
                                            ...
                                            <div class="box-content d-flex ">
                                                <a class='effect-ajax box-image-link bg-shadow' data-dsn-ajax='work'
                                                    ...
                                                    <div class="box-image-bg before-z-index dsn-swiper-parallax-transform"
                                                        data-swiper-parallax-scale="1.2" data-overlay="3">
                                                        <img class="cover-bg-img"
                                        ...
                                        <article
                                            ...
                                            <div class="box-content d-flex ">
                                                <a class='effect-ajax box-image-link bg-shadow' data-dsn-ajax='work'
                                                    ...
                                                    <div class="box-image-bg before-z-index dsn-swiper-parallax-transform"
                                                        data-swiper-parallax-scale="1.2" data-overlay="2">
                                                        <img class="cover-bg-img"
                                                ...
                                                <div class="content-inner border-top">
                                                    <div class="d-flex align-items-center ">
                                                        ...
                                                        <div class="label box-text">
                                                            <h4 class="testimonial-name sm-title-block">MTL Graphic
                                                            </h4>
