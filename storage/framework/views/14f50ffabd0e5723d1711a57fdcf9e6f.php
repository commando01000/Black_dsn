    ...
    <header id="site_menu_header" class="site-header  dsn-container d-none dsn-hamburger">
        <div class="main-logo">
            <a aria-current='page' class='custom-logo-link main-brand effect-ajax' data-dsn-text='Blackdsn' href='index.htm'
                rel='home'>
                <img src= "<?php echo e(asset('front_asset/assets/img/logo.png')); ?>" class="custom-logo logo-light" alt="Blackdsn">
        ...
        <nav class="main-navigation ">
            ...
            <ul id="dsn-primary-list" class="primary-nav h2">
                ...
                <li class="nav-item ">
                    <a href='<?php echo e(route('about-us')); ?>' title='Home'>
                        <span class="overflow">About</span>
                    </a>
                </li>
                <li class="nav-item ">
                    <a href='<?php echo e(route('contact')); ?>' title='Home'>
    ...
    <!-- ========== End Menu ========== -->
<?php /**PATH G:\xampp\htdocs\Black_dsn\resources\views/layouts/front/header.blade.php ENDPATH**/ ?>