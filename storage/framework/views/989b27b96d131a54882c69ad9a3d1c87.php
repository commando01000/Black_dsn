...
<div class="social-side d-flex align-items-center flex-column justify-content-center">
    ...
    <ul class="socials d-flex flex-column-reverse">
        <li style="--dsn-index-animate : 0;">
            <a href="<?php echo e(Utility::getsettings('contact_facebook')); ?>" target="_blank" rel="nofollow">
                <i class="fab fa-facebook-f" aria-hidden="true"></i> <span>Fb</span>
            </a>
        </li>
        <li style="--dsn-index-animate : 1;">
            <a href="<?php echo e(Utility::getsettings('contact_instagram')); ?>" target="_blank" rel="nofollow">
                <i class="fab fa-instagram" aria-hidden="true"></i><span>Instagram</span>
            </a>
        </li>
        <li style="--dsn-index-animate : 2;">
            <a href="<?php echo e(Utility::getsettings('contact_twitter')); ?>" target="_blank" rel="nofollow">
                <i class="fab fa-twitter" aria-hidden="true"></i><span>Tw</span>
            </a>
        </li>
        <li style="--dsn-index-animate : 3;">
            <a href="<?php echo e(Utility::getsettings('contact_linkedin')); ?>" target="_blank" rel="nofollow">
...
<!-- ========== End Social ========== -->
<?php /**PATH C:\Users\dell\source\repos\Black_dsn\resources\views/layouts/front/social.blade.php ENDPATH**/ ?>