    ...
    <div id="page_wrapper" class="wrapper">
        ...
        <div class="box-under-bottom-img mb-section">
            <div class="img-box-parallax before-z-index dsn-animate dsn-effect-down h-v-80" data-dsn-triggerhook="bottom"
                ...
                <img class="has-bigger-scale cover-bg-img has-direction" src= "<?php echo e(asset('front_asset/assets/img/about-5.jpg')); ?>"
                    alt=''>
            </div>
        ...
        <div class="dsn-container dsn-right-container over-hidden background-section section-padding">
            ...
            <div class="d-grid grid-md-3 grid-sm-2 dsn-team">
                <div class="team-item p-relative grid-item box-hover-image">
                    <div class="team-item-inner  background-main">
                        <div class="avatar box-img" data-overlay="4">
                            <img class="cover-bg-img" src= "<?php echo e(asset('front_asset/assets/img/team/3.jpg')); ?>" alt=''>
                        </div>
                ...
                <div class="team-item p-relative grid-item box-hover-image">
                    <div class="team-item-inner  background-main">
                        <div class="avatar box-img" data-overlay="4">
                            <img class="cover-bg-img" src= "<?php echo e(asset('front_asset/assets/img/team/2.jpg')); ?>" alt=''>
                        </div>
                        <div class="team-content border-before text-center">
                ...
                <div class="team-item p-relative grid-item box-hover-image">
                    <div class="team-item-inner  background-main">
                        <div class="avatar box-img" data-overlay="4">
                            <img class="cover-bg-img" src= "<?php echo e(asset('front_asset/assets/img/team/1.jpg')); ?>" alt=''>
                        </div>
                        <div class="team-content border-before text-center">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide testimonial-inner-item border-style">
                                        <div class="avatar box-img dsn-auto">
                                            <img src= "<?php echo e(asset('front_asset/assets/img/team/1.jpg')); ?>" class="cover-bg-img"
                                                alt=''>
                                        </div>
                                        <div class="testimonial-item">
                                            ...
                                            <div class="content-inner border-top">
                                                <div class="d-flex align-items-center ">
                                                    <div class="avatar box-img dsn-auto">
                                                        <img src= "<?php echo e(asset('front_asset/assets/img/team/1.jpg')); ?>"
                                    ...
                                    <div class="swiper-slide testimonial-inner-item border-style">
                                        <div class="avatar box-img dsn-auto">
                                            <img src= "<?php echo e(asset('front_asset/assets/img/team/2.jpg')); ?>" class="cover-bg-img"
                                                alt=''>
                                        </div>
                                        <div class="testimonial-item">
                                            <div class="testimonial-content mb-25">
                                            ...
                                            <div class="content-inner border-top">
                                                <div class="d-flex align-items-center ">
                                                    <div class="avatar box-img dsn-auto">
                                                        <img src= "<?php echo e(asset('front_asset/assets/img/team/2.jpg')); ?>"
                                                            class="cover-bg-img" alt=''>
                                                    </div>
                                                    <div class="label box-text">
                                    ...
                                    <div class="swiper-slide testimonial-inner-item border-style">
                                        <div class="avatar box-img dsn-auto">
                                            <img src= "<?php echo e(asset('front_asset/assets/img/team/3.jpg')); ?>" class="cover-bg-img"
                                                alt=''>
                                        </div>
                                        <div class="testimonial-item">
                                            <div class="testimonial-content mb-25">
                                            ...
                                            <div class="content-inner border-top">
                                                <div class="d-flex align-items-center ">
                                                    <div class="avatar box-img dsn-auto">
                                                        <img src= "<?php echo e(asset('front_asset/assets/img/team/3.jpg')); ?>"
                                                            class="cover-bg-img" alt=''>
                                                    </div>
                                                    <div class="label box-text">
                                    ...
                                    <div class="swiper-slide testimonial-inner-item border-style">
                                        <div class="avatar box-img dsn-auto">
                                            <img src= "<?php echo e(asset('front_asset/assets/img/team/4.jpg')); ?>" class="cover-bg-img"
                                                alt=''>
                                        </div>
                                        <div class="testimonial-item">
                                            <div class="testimonial-content mb-25">
                                            ...
                                            <div class="content-inner border-top">
                                                <div class="d-flex align-items-center ">
                                                    <div class="avatar box-img dsn-auto">
                                                        <img src= "<?php echo e(asset('front_asset/assets/img/team/4.jpg')); ?>"
                                                            class="cover-bg-img" alt=''>
                                                    </div>
                                                    <div class="label box-text">
            ...
            <div class="d-grid grid-md-4 grid-sm-2 dsn-brand">
                <div class="brand-item border-style">
                    <div class="brand-item-inner over-hidden p-relative">
                        <img src="<?php echo e(asset('front_asset/assets/img/team/1.jpg')); ?>" alt="">
                    </div>
                </div>
                <div class="brand-item border-style">
                    <div class="brand-item-inner over-hidden p-relative">
                        <img src="<?php echo e(asset('front_asset/assets/img/team/2.jpg')); ?>" alt="">
                    </div>
                </div>
                <div class="brand-item border-style">
                    <div class="brand-item-inner over-hidden p-relative">
                        <img src="<?php echo e(asset('front_asset/assets/img/team/3.jpg')); ?>" alt="">
                    </div>
                </div>
                <div class="brand-item border-style">
                    <div class="brand-item-inner over-hidden p-relative">
                        <img src="<?php echo e(asset('front_asset/assets/img/team/4.jpg')); ?>" alt="">
                    </div>
                </div>
                <div class="brand-item border-style">
                    <div class="brand-item-inner over-hidden p-relative">
