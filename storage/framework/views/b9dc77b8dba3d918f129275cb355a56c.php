                        ...
                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="dsn-up service-item p-relative grid-item style-box">
                                <div class="service-item-inner border-style number-item h-100">
                                    <div class="dsn-icon">
                                        <img style="width: 80px; height:80px;" src="<?php echo e(Storage::url($service->cover)); ?>" alt="">
                                    </div>
                                    <div class="service-content p-relative">
                                        <h4 class="service_title  title-block border-bottom pb-20 mb-20"><?php echo e($service->title); ?></h4>
                                        ...
                                        <article
                                            ...
                                            <div class="box-content d-flex ">
                                                <a class='effect-ajax box-image-link bg-shadow'
                                                    ...
                                                    <div class="box-image-bg before-z-index dsn-swiper-parallax-transform"
                                                        data-overlay="4">
                                                        <img src="<?php echo e(asset('front_asset/assets/img/blog/1.jpg')); ?>"
                                                            class="cover-bg-img" alt="">
                                                    </div>
                                                </a>
                                                <div class="post-content dsn-bg p-relative z-index-1 d-flex flex-column">
                                        ...
                                        <article
                                            ...
                                            <div class="box-content d-flex ">
                                                <a class='effect-ajax box-image-link bg-shadow'
                                                    ...
                                                    <div class="box-image-bg before-z-index dsn-swiper-parallax-transform"
                                                        data-overlay="4">
                                                        <img src="<?php echo e(asset('front_asset/assets/img/blog/2.jpg')); ?>"
                                                            class="cover-bg-img" alt="">
                                                    </div>
                                                </a>
                                                <div class="post-content dsn-bg p-relative z-index-1 d-flex flex-column">
                                        ...
                                        <article
                                            ...
                                            <div class="box-content d-flex ">
                                                <a class='effect-ajax box-image-link bg-shadow'
                                                    ...
                                                    <div class="box-image-bg before-z-index dsn-swiper-parallax-transform"
                                                        data-overlay="4">
                                                        <img src="<?php echo e(asset('front_asset/assets/img/blog/3.jpg')); ?>"
                                                            class="cover-bg-img" alt="">
                                                    </div>
                                                </a>
                                                <div class="post-content dsn-bg p-relative z-index-1 d-flex flex-column">
                    ...
                    <div class="d-grid grid-sm-4 d-grid-no-space dsn-brand">
                        <div class="brand-item border-bottom border-right">
                            <div class="brand-item-inner  over-hidden p-relative ">
                                <img src="<?php echo e(asset('front_asset/assets/img/brand/1.svg')); ?>" alt="">
                            </div>
                        </div>
                        <div class="brand-item border-bottom border-right">
                            <div class="brand-item-inner  over-hidden p-relative ">
                                <img src="<?php echo e(asset('front_asset/assets/img/brand/2.svg')); ?>" alt="">
                            </div>
                        </div>
                        <div class="brand-item border-bottom border-right">
                            <div class="brand-item-inner  over-hidden p-relative ">
                                <img src="<?php echo e(asset('front_asset/assets/img/brand/3.svg')); ?>" alt="">
                            </div>
                        </div>
                        <div class="brand-item border-bottom">
                            <div class="brand-item-inner  over-hidden p-relative ">
                                <img src="<?php echo e(asset('front_asset/assets/img/brand/4.svg')); ?>" alt="">
                            </div>
                        </div>
                        <div class="brand-item border-right">
                            <div class="brand-item-inner  over-hidden p-relative ">
                                <img src="<?php echo e(asset('front_asset/assets/img/brand/5.svg')); ?>" alt="">
                            </div>
                        </div>
                        <div class="brand-item border-right">
                            <div class="brand-item-inner  over-hidden p-relative ">
                                <img src="<?php echo e(asset('front_asset/assets/img/brand/6.svg')); ?>" alt="">
                            </div>
                        </div>
                        <div class="brand-item border-right">
                            <div class="brand-item-inner  over-hidden p-relative ">
